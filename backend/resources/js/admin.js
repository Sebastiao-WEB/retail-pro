...
const pageModules = {
    ...
    'cash-sessions-active': () => import('./admin/cash-sessions.js'),
    'cash-sessions-closed': () => import('./admin/cash-sessions.js'),
    reversals: () => import('./admin/reversals.js'),
    registers: () => import('./admin/registers.js'),
    'stock-locations': () => import('./admin/stock-locations.js'),
    'stock-reload': () => import('./admin/stock-reload.js'),
    'stock-movements': () => import('./admin/stock-movements.js'),
